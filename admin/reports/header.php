		...
		<ul>
			...
			<li>
				<div class="dropdown">
					...
					<div class="dropdown-content">
						<a class="dropdown-item" href="fusers.php">Frequent User</a>
						<a class="dropdown-item" href="fmovie.php">Favorite Movie</a>
						<a class="dropdown-item" href="timeslot.php">Favorite Timeslot</a>
						<a class="dropdown-item" href="day.php">Favorite Day</a>
					</div>
				</div>
			</li>
			<li>
